    ...
    $(function () {
        $("#exampleTableEvents").bootstrapTable({
            ...
            columns: [{
                ...
                align: 'center',
                formatter: function (value, row) {
                    var context = '<span class="label label-danger" style="cursor: pointer" title="点击激活权限" onclick="cmsPermList.changeState(' + row.id + ', \'激活\')">冻结</span>';
                    if (value == 0) {
                        context = '<span class="label label-success" style="cursor: pointer" title="点击冻结权限" onclick="cmsPermList.changeState(' + row.id + ', \'冻结\')">激活</span>';
                    }
                    return context;
                }
            }, {
