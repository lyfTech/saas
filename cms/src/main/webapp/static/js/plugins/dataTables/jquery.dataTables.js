...
(/** @lends <global> */function( $ ) {
	...
	function _fnFilterComplete ( oSettings, oInput, iForce )
	{
		...
		// @todo As per sort - can this be moved into an event org.saas.service.system.handler?
	...
	function _fnSort ( oSettings )
	{
		...
		// Resolve any column types that are unknown due to addition or invalidation
		// @todo Can this be moved into a 'data-ready' org.saas.service.system.handler which is called when
	 ...
	 *  @param {object} settings dataTables settings object
	 *  @param {node} attachTo node to attach the org.saas.service.system.handler to
	...
	/**
	 * Attach a sort org.saas.service.system.handler (click) to a node
	 *  @param {object} settings dataTables settings object
	 *  @param {node} attachTo node to attach the org.saas.service.system.handler to
	 *  @param {int} colIdx column sorting index
	 *  @param {function} [callback] callback function
	...
	DataTable = function( options )
	{
		...
		this.each(function() {
			...
			if ( oInit.oLanguage.sUrl !== "" )
			{
				 ...
				 * _fnInitialise will be fired by the returned Ajax org.saas.service.system.handler, rather than the constructor
				 */
			...
			/*
			 * Sorting
			 * @todo For modularisation (1.11) this needs to do into a sort start up org.saas.service.system.handler
			 */
	...
	$.each( [ 'on', 'one', 'off' ], function (i, key) {
		_api_register( key+'()', function ( /* event, org.saas.service.system.handler */ ) {
	...
	DataTable.defaults.column = {
		 ...
		 * behaviour of the sort org.saas.service.system.handler (i.e. only allow ascending ordering etc)
