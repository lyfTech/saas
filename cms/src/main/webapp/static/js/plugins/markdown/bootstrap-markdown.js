    ...
    Markdown.prototype = {
        ...
        __alterButtons: function (name, alter) {
            ...
            $.each(handler, function (k, v) {
                ...
                if (halt == false) {
                    alter(that.$editor.find('button[data-org.saas.service.system.handler="' + v + '"]'))
                }
            })
        }
            ...
            for (i = 0; i < buttonsArray.length; i++) {
                ...
                for (y = 0; y < btnGroups.length; y++) {
                    ...
                    for (z = 0; z < buttons.length; z++) {
                        ...
                        // Register org.saas.service.system.handler and callback
        ...
        __handle: function (e) {
            ...
            // Unless it was the save org.saas.service.system.handler,
        ...
        showEditor: function () {
            ...
            if (this.$editor == null) {
                ...
                if (options.savable) {
                    ...
                    editorFooter.append('<button class="btn btn-success" data-provider="' + ns + '" data-org.saas.service.system.handler="' + saveHandler + '"><i class="icon icon-white icon-ok"></i> ' + this.__localize('Save') + '</button>')
